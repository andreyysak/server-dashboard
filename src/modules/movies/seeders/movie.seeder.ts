...
export class MoviesSeeder {
    ...
    async seed(userId: number = 1) {
        const moviesData = [
            {
                ...
                overview: 'Кобб — талановитий злодій, кращий у мистецтві витягування секретів.',
                status: MovieStatus.WATCHED,
                user_rating: 10,
                user_comment: 'Один з найкращих фільмів Нолана.',
                details: {
                    ...
                    cast: [
                        ...
                        { name: 'Cillian Murphy', character: 'Robert Fischer', profile_path: null }
                    ],
                    production_companies: [{ name: 'Warner Bros. Pictures', logo_path: null }]
                }
            },
            {
                tmdb_id: 157336,
                ...
                overview: 'Команда дослідників вирушає у подорож за межі нашої галактики.',
                status: MovieStatus.WATCHED,
                user_rating: 9,
                user_comment: 'Неймовірна музика Ганса Циммера.',
                details: {
                    director: 'Christopher Nolan',
                    budget: 165000000,
                    revenue: 675120017,
                    runtime: 169,
                    cast: [{ name: 'Matthew McConaughey', character: 'Cooper', profile_path: null }],
            ...
            },
            {
                ...
                overview: 'Нео дізнається, що світ навколо нього — це комп’ютерна симуляція.',
                status: MovieStatus.WATCH_LATER,
                details: {
                    director: 'Lana Wachowski',
                    budget: 63000000,
                    revenue: 463517383,
                    runtime: 136,
                    cast: [{ name: 'Keanu Reeves', character: 'Neo', profile_path: null }],
            ...
            },
            {
                ...
                details: {
                    ...
                    revenue: 100853753,
                    runtime: 139,
                    cast: [{ name: 'Brad Pitt', character: 'Tyler Durden', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 1004558444,
                    runtime: 152,
                    cast: [{ name: 'Heath Ledger', character: 'Joker', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 213928762,
                    runtime: 154,
                    cast: [{ name: 'John Travolta', character: 'Vincent Vega', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                overview: 'Історія про чоловіка з добрим серцем, який опинився в центрі історичних подій.',
                status: MovieStatus.WATCHED,
                user_rating: 10,
                details: {
                    ...
                    revenue: 677387716,
                    runtime: 142,
                    cast: [{ name: 'Tom Hanks', character: 'Forrest Gump', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 245066411,
                    runtime: 175,
                    cast: [{ name: 'Marlon Brando', character: 'Vito Corleone', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 1118888979,
                    runtime: 201,
                    cast: [{ name: 'Elijah Wood', character: 'Frodo', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 286701684,
                    runtime: 189,
                    cast: [{ name: 'Michael Clarke Duncan', character: 'John Coffey', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 2046239637,
                    runtime: 149,
                    cast: [{ name: 'Robert Downey Jr.', character: 'Iron Man', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 775398007,
                    runtime: 121,
                    cast: [{ name: 'Mark Hamill', character: 'Luke Skywalker', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 381109762,
                    runtime: 116,
                    cast: [{ name: 'Michael J. Fox', character: 'Marty McFly', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 321365567,
                    runtime: 195,
                    cast: [{ name: 'Liam Neeson', character: 'Oskar Schindler', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 109676311,
                    runtime: 130,
                    cast: [{ name: 'Hugh Jackman', character: 'Robert Angier', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 538400000,
                    runtime: 124,
                    cast: [{ name: 'Harrison Ford', character: 'Han Solo', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 28341469,
                    runtime: 142,
                    cast: [{ name: 'Morgan Freeman', character: 'Red', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                overview: 'Детективи шукають вбивцю, що використовує сім смертних гріхів.',
                status: MovieStatus.WATCHED,
                user_rating: 9,
                details: {
                    director: 'David Fincher',
            ...
            },
            {
                ...
                details: {
                    ...
                    revenue: 871368364,
                    runtime: 178,
                    cast: [{ name: 'Ian McKellen', character: 'Gandalf', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 926047194,
                    runtime: 179,
                    cast: [{ name: 'Viggo Mortensen', character: 'Aragorn', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 102600000,
                    runtime: 202,
                    cast: [{ name: 'Al Pacino', character: 'Michael Corleone', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 672806292,
                    runtime: 107,
                    cast: [{ name: 'Bruce Willis', character: 'Malcolm Crowe', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                details: {
                    ...
                    revenue: 272742922,
                    runtime: 118,
                    cast: [{ name: 'Anthony Hopkins', character: 'Hannibal Lecter', profile_path: null }],
                    production_companies: []
                }
            },
            {
                ...
                overview: 'Хлопчик намагається вижити в японському таборі під час війни.',
                status: MovieStatus.WATCH_LATER,
                details: {
                    director: 'Steven Spielberg',
                    budget: 35000000,
                    revenue: 22238696,
                    runtime: 153,
                    cast: [{ name: 'Christian Bale', character: 'Jim', profile_path: null }],
                    production_companies: []
                }
            }
        ];
        ...
        for (const data of moviesData) {
            let details = await this.detailsRepo.findOne({ where: { tmdb_id: data.tmdb_id } });
