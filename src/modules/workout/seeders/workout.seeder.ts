  ...
  async seed(userId: number = 1) {
    const workoutsData = [
      ...
      },
      {
        ...
        exercises: [{ name: 'Біг', distance_km: 7.5, duration_seconds: 2700 }],
      },
      {
        ...
        exercises: [{ name: 'Гра в футбол', duration_seconds: 5400 }],
      },
      {
      ...
      },
      {
        ...
        duration_minutes: 30,
        exercises: [{ name: 'Розтяжка та асани', duration_seconds: 1800 }],
      },
      {
      ...
      },
      {
        ...
        type: WorkoutType.FOOTBALL,
        duration_minutes: 60,
        exercises: [{ name: 'Дриблінг та удари', duration_seconds: 3600 }],
      },
      {
        title: 'Ранкова Йога',
        type: WorkoutType.YOGA,
        duration_minutes: 20,
        exercises: [{ name: 'Привітання сонцю', duration_seconds: 1200 }],
      },
      {
        title: 'Силова: Руки',
        type: WorkoutType.GYM,
      ...
      },
      {
        ...
        type: WorkoutType.YOGA,
        duration_minutes: 25,
        exercises: [{ name: 'Релаксація', duration_seconds: 1500 }],
      },
      {
        title: 'Футбол: Товариський матч',
        type: WorkoutType.FOOTBALL,
        duration_minutes: 120,
        exercises: [{ name: 'Гра 11х11', duration_seconds: 7200 }],
      },
    ];
