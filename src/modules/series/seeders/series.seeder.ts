...
export class SeriesSeeder {
    ...
    async seed(userId: number = 1) {
        const seriesData = [
            {
                ...
                details: {
                    ...
                    cast: [{ name: 'Kit Harington', character: 'Jon Snow', profile_path: null }],
            ...
            },
            {
                ...
                details: {
                    ...
                    cast: [{ name: 'Bryan Cranston', character: 'Walter White', profile_path: null }]
                }
            },
            {
                tmdb_id: 100088,
                ...
                details: {
                    ...
                    cast: [{ name: 'Pedro Pascal', character: 'Joel', profile_path: null }]
                }
            },
            {
                tmdb_id: 66732,
            ...
            },
            {
                ...
                current_episode: 10,
                user_rating: 9,
                details: { creator: 'Álex Pina', number_of_seasons: 5, number_of_episodes: 41 }
            },
            {
                tmdb_id: 60574,
                ...
                current_season: 3,
                current_episode: 4,
                details: { creator: 'Steven Knight', number_of_seasons: 6, number_of_episodes: 36 }
            },
            {
                tmdb_id: 60059,
                ...
                details: { creator: 'Vince Gilligan', number_of_seasons: 6, number_of_episodes: 63 }
            },
            {
                tmdb_id: 42009,
                ...
                current_season: 6,
                current_episode: 2,
                details: { creator: 'Charlie Brooker', number_of_seasons: 6, number_of_episodes: 27 }
            },
            {
                tmdb_id: 67744,
                title: 'Мандалорець',
                ...
                current_episode: 8,
                user_rating: 8,
                details: { creator: 'Jon Favreau', number_of_seasons: 3, number_of_episodes: 24 }
            },
            {
                tmdb_id: 1412,
                title: 'Стріла',
            ...
            },
            {
                ...
                current_episode: 13,
                user_rating: 10,
                details: { creator: 'Sam Esmail', number_of_seasons: 4, number_of_episodes: 45 }
            },
            {
                tmdb_id: 76479,
                ...
                current_episode: 8,
                user_rating: 9,
                details: { creator: 'Eric Kripke', number_of_seasons: 4, number_of_episodes: 32 }
            },
            {
                tmdb_id: 85271,
                title: 'ВандаВіжен',
                ...
                current_season: 1,
                current_episode: 9,
                details: { creator: 'Jac Schaeffer', number_of_seasons: 1, number_of_episodes: 9 }
            },
            {
                tmdb_id: 1402,
                title: 'Ходячі мерці',
            ...
            },
            {
                ...
                current_season: 3,
                current_episode: 1,
                details: { creator: 'Lauren Schmidt Hissrich', number_of_seasons: 3, number_of_episodes: 24 }
            },
            {
                tmdb_id: 93405,
            ...
            },
            {
                ...
                current_episode: 3,
                user_rating: 10,
                details: { creator: 'Steven Moffat, Mark Gatiss', number_of_seasons: 4, number_of_episodes: 12 }
            },
            {
                tmdb_id: 1434,
                title: 'Сім’янин',
            ...
            },
            {
                ...
                current_episode: 10,
                user_rating: 10,
                details: { creator: 'Dan Harmon, Justin Roiland', number_of_seasons: 7, number_of_episodes: 71 }
            },
            {
                tmdb_id: 2316,
                title: 'Офіс',
        ...
        for (const data of seriesData) {
            ...
            if (!details) {
                details = this.detailsRepo.create({ tmdb_id: data.tmdb_id, ...data.details });
                await this.detailsRepo.save(details);
            }

            const seriesExists = await this.seriesRepo.findOne({ where: { tmdb_id: data.tmdb_id, user_id: userId } });
            if (!seriesExists) {
