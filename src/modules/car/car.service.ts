...
export class CarService {
  ...
  async update(userId: number, carId: number, updateCarDto: UpdateCarDto): Promise<Car> {
  ...
  async updateMileage(userId: number, carId: number, additionalKm: number): Promise<Car> {
    const car = await this.findOne(userId, carId);
